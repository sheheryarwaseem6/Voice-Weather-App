...
const LaunchRequestHandler = {
    ...
    handle(handlerInput) {
        const speakOutput = `<speak> 
            <voice name="Matthew">
                Hello! <break strength="weak"/> this is Sheri Weather Assistant.
...
const WeatherAppIntentHandler = {
    canHandle(handlerInput) {
        return Alexa.getRequestType(handlerInput.requestEnvelope) === 'IntentRequest'
            && Alexa.getIntentName(handlerInput.requestEnvelope) === 'WeatherAppIntent';
    },
    async handle(handlerInput) {
        
        const slots = handlerInput.requestEnvelope.request.intent.slots;
        const cityName = slots.city.value || "Karachi";
        
        const URL = `http://api.openweathermap.org/data/2.5/weather?q=${cityName}&appid=0909502029355100ef3b5bec522eac16&units=metric`;
